...
// دیکشنری هوشمند ترجمه‌ها (شامل انگلیسی، فارسی و پشتو)
const translations: Record<string, any> = {
  ...
  fa: {
    ...
    dir: "rtl",
    companyNum: "شماره ثبت بریتانیا: 17063286",
    networkBadge: "شبکه جهانی",
    teamSubtitle: "به رهبری متخصصان صنعت در حوزه فین‌تک، توسعه نرم‌افزار و روابط بین‌الملل."
  },
  ps: {
    title: "د صافی ایجنسۍ په اړه",
    subtitle: "د Safi International Capital LTD رسمي تصدیق او ډیجیټل خدماتو څانګه.",
    legalTitle: "په انګلستان کې په قانوني توګه ثبت شوی",
    legalDesc: "صافی ایجنسي د Safi International Capital LTD تر څار لاندې کار کوي، کوم چې په انګلستان کې یو ثبت شوی خصوصي محدود شرکت دی (د شرکت شمېره: 17063286). موږ د اروپا او انګلستان سختو سوداګریزو معیارونو ته ژمن یو.",
    privacyTitle: "سخت محرمیت او د معلوماتو ساتنه",
    privacyDesc: "ستاسو د هویت اسناد، پاسپورتونه او د پته ثبوت په بشپړ محرمیت سره کوډ شوي او ساتل کیږي. موږ هغسې غیر مجاز دریمو لورو ته ستاسو معلومات نه شریکوو.",
    whatWeDoTitle: "زموږ دندې",
    whatWeDoDesc: "موږ په انګلستان او اروپا کې مهاجرینو او اتباعو ته د صفر څخه تر سل پورې د اکاونټ جوړولو خدمتونه وړاندې کوو. د ډیلیورو رایډر اکاونټونو څخه تر نړیوالو بانکي ترتیباتو پورې، موږ قانوني اړتیاوې پوره کوو.",
    ecoTitle: "د صافی ډیجیټل اکوسیستم",
    ecoDesc: "زموږ د مالي، تعلیمي او ډیجیټل پلیټ فارمونو نړیواله شبکه وګورئ.",
    teamTitle: "زموږ د رهبرۍ ټیم",
    dir: "rtl",
    companyNum: "د انګلستان د شرکت شمېره: 17063286",
    networkBadge: "نړیواله شبکه",
    teamSubtitle: "په فین ټیک، پرمختیا او نړیوالو اړیکو کې د صنعت د متخصصینو لخوا رهبري کیږي."
  }
};

// لیست اکوسیستم شرکت‌ها با پشتیبانی از انگلیسی، فارسی و پشتو
const getEcosystem = (lang: string) => [
  {
    ...
    desc: lang === 'fa' ? "شرکت مادر و بازوی سرمایه‌گذاری بین‌المللی (ثبت بریتانیا)." : lang === 'ps' ? "مورنی شرکت او د نړیوالې پانګونې څانګه (انګلستان ثبت: 17063286)." : "Parent company & international investment arm (UK Reg: 17063286)."
  },
  {
    name: "SafiPay",
    url: "https://safipay.net/",
    logo: "https://img.logo.dev/safipay.net?token=pk_KFxIPBNeQa6ZPc2CP18vhQ&format=webp&retina=true",
    desc: lang === 'fa' ? "خدمات بانکداری بین‌المللی چندارزی و صدور کارت مجازی." : lang === 'ps' ? "څو اسعارو نړیوال بانکداري او د مجازی کارټونو صادرول." : "Multi-currency international banking & virtual card issuance."
  },
  {
    name: "Safi TopUp",
    url: "https://safitopup.site",
    logo: "/company/safi-topup.jpg",
    desc: lang === 'fa' ? "شارژ موبایل جهانی، بسته‌های اینترنت و گیفت کارت." : lang === 'ps' ? "نړیوال ګرځنده چارجونه، د انټرنیټ بنډلونه او ډیجیټل کارتونه." : "Global mobile recharges, data bundles, and gift cards."
  },
  {
    name: "SafiPro",
    url: "https://safipro.site",
    logo: "/company/SafiPro.jpg",
    desc: lang === 'fa' ? "برند تجارت الکترونیک پریمیوم برای پوشاک مدرن و سفارشی." : lang === 'ps' ? "د عصري او ځانګړو جامو لپاره پریمیم ای کامرس برنډ." : "Premium e-commerce brand for modern and custom apparel."
  },
  {
    name: "Safi Academy",
    url: "https://safiacademy.org/",
    logo: "/company/academy.jpg",
    desc: lang === 'fa' ? "پلتفرم جهانی گواهینامه‌های IT و مالی دیجیتال." : lang === 'ps' ? "د نړیوالو آی ټي او ډیجیټل مالي تصدیقونو پلیټ فارم." : "Global IT & digital financial certification platform."
  },
  {
    name: "Safi AI",
    url: "https://www.safiai.site/",
    logo: "/company/ailogo.png",
    desc: lang === 'fa' ? "تولید پیشرفته متن، تصویر و ویدیوی هوش مصنوعی." : lang === 'ps' ? "پرمختللی څو ماډله د مصنوعي ځیرکتیا متن، انځور او ویډیو تولید." : "Advanced multi-modal AI text, image, and video generation."
  },
  {
    ...
    desc: lang === 'fa' ? "بینش‌ها و به‌روزرسانی‌ها از بنیان‌گذار و مدیرعامل." : lang === 'ps' ? "زموږ د بنسټ ایښودونکي او اجراییوي رییس لیدونه او تازه معلومات." : "Insights and updates from our Founder & CEO."
  }
];

// لیست تیم مدیریتی به همراه نقش‌ها برای هر زبان
const getTeam = (lang: string) => [
  { 
    name: lang === 'en' ? "Shaheen Safi" : "شاهین صافی", 
    role: lang === 'fa' ? "بنیان‌گذار، مدیرعامل و معمار ارشد" : lang === 'ps' ? "بنسټ ایښودونکی، اجراییوي رییس او مشر معمار" : "Founder, CEO & Chief Architect", 
    image: "/team/shaheen.jpeg" 
  },
  { 
    name: lang === 'en' ? "Mujtaba Rahmani" : "مجتبی رحمانی", 
    role: lang === 'fa' ? "مدیر ارشد عملیات (COO)" : lang === 'ps' ? "د عملیاتو مشر (COO)" : "Chief Operating Officer (COO)", 
    image: "/team/mujtaba.jpeg" 
  },
  { 
    name: lang === 'en' ? "Sahel Salem" : "ساحل سالم", 
    role: lang === 'fa' ? "مدیر روابط اروپا" : lang === 'ps' ? "د اروپا د اړیکو رییس" : "European Relations Director", 
    image: "/team/sahel.jpeg" 
  },
  { 
    name: lang === 'en' ? "Shirin Gol Ahmadi" : "شیرین گل احمدی", 
    role: lang === 'fa' ? "مدیر شرکت و متخصص هوش مصنوعی" : lang === 'ps' ? "د شرکت مدیره او د مصنوعي ځیرکتیا متخصصه" : "Company Manager & AI Lead", 
