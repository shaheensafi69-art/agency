...
// لیست اکوسیستم شرکت‌های شما (با ترجمه توضیحات برای فارسی)
const getEcosystem = (lang: string) => [
  {
    ...
    desc: lang === 'fa' ? "شرکت مادر و بازوی سرمایه‌گذاری بین‌المللی (ثبت بریتانیا)." : "Parent company & international investment arm (UK Reg: 17063286)."
  },
  {
    name: "SafiPay",
    url: "https://safipay.net/",
    logo: "https://img.logo.dev/safipay.net?token=pk_KFxIPBNeQa6ZPc2CP18vhQ&format=webp&retina=true",
    desc: lang === 'fa' ? "خدمات بانکداری بین‌المللی چندارزی و صدور کارت مجازی." : "Multi-currency international banking & virtual card issuance."
  },
  {
    name: "Safi TopUp",
    url: "https://safitopup.site",
    logo: "/company/safi-topup.jpg",
    desc: lang === 'fa' ? "شارژ موبایل جهانی، بسته‌های اینترنت و گیفت کارت." : "Global mobile recharges, data bundles, and gift cards."
  },
  {
    name: "SafiPro",
    url: "https://safipro.site",
    logo: "/company/SafiPro.jpg",
    desc: lang === 'fa' ? "برند تجارت الکترونیک پریمیوم برای پوشاک مدرن و سفارشی." : "Premium e-commerce brand for modern and custom apparel."
  },
  {
    name: "Safi Academy",
    url: "https://safiacademy.org/",
    logo: "/company/academy.jpg",
    desc: lang === 'fa' ? "پلتفرم جهانی گواهینامه‌های IT و مالی دیجیتال." : "Global IT & digital financial certification platform."
  },
  {
    name: "Safi AI",
    url: "https://www.safiai.site/",
    logo: "/company/ailogo.png",
    desc: lang === 'fa' ? "تولید پیشرفته متن، تصویر و ویدیوی هوش مصنوعی." : "Advanced multi-modal AI text, image, and video generation."
  },
  {
    ...
    desc: lang === 'fa' ? "بینش‌ها و به‌روزرسانی‌ها از بنیان‌گذار و مدیرعامل." : "Insights and updates from our Founder & CEO."
  }
];

// لیست تیم مدیریتی به همراه تصاویر دقیق از پوشه team (با ترجمه نقش‌ها)
const getTeam = (lang: string) => [
  { 
    name: lang === 'fa' ? "شاهین صافی" : "Shaheen Safi", 
    role: lang === 'fa' ? "بنیان‌گذار، مدیرعامل و معمار ارشد" : "Founder, CEO & Chief Architect", 
    image: "/team/shaheen.jpeg" 
  },
  { 
    name: lang === 'fa' ? "مجتبی رحمانی" : "Mujtaba Rahmani", 
    role: lang === 'fa' ? "مدیر ارشد عملیات (COO)" : "Chief Operating Officer (COO)", 
    image: "/team/mujtaba.jpeg" 
  },
  { 
    name: lang === 'fa' ? "ساحل سالم" : "Sahel Salem", 
    role: lang === 'fa' ? "مدیر روابط اروپا" : "European Relations Director", 
    image: "/team/sahel.jpeg" 
  },
  { 
    name: lang === 'fa' ? "شیرین گل احمدی" : "Shirin Gol Ahmadi", 
    role: lang === 'fa' ? "مدیر شرکت و متخصص هوش مصنوعی" : "Company Manager & AI Lead", 
