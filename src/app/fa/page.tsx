      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24 lg:pt-24">
        <div className="text-center max-w-4xl mx-auto space-y-8 relative">
          ...
          <div className="inline-flex items-center space-x-2 space-x-reverse bg-emerald-500/10 border border-emerald-500/30 px-5 py-2 rounded-full text-emerald-400 text-sm font-semibold shadow-[0_0_30px_rgba(16,185,129,0.2)] transform hover:scale-105 transition-transform duration-300">
            ...
            <span>پارتنر رسمی ثبت و تأیید مدارک در بریتانیا و اروپا</span>
          </div>

          <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight leading-tight">
            مسیر دیجیتال خود را <br className="hidden sm:block" />
          ...
          <p className="text-lg text-zinc-400 leading-relaxed max-w-2xl mx-auto font-medium">
            صافی اگنسی خدمات ۱۰۰٪ امن و حرفه‌ای ساخت اکانت را ارائه می‌دهد. از افتتاح حساب رایدر دیلیورو تا تأیید کامل مدارک حقوقی؛ ما تمام کارهای سخت را انجام می‌دهیم تا شما با خیالی آسوده شروع به کسب درآمد کنید.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-6">
            ...
            >
              <span>ثبت‌نام اکانت دیلیورو</span>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-zinc-800/50">
        ...
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-3xl md:text-5xl font-extrabold text-white">
            قوانین و الزامات رسمی دیلیورو
          </h2>
          <p className="text-zinc-400 max-w-2xl mx-auto font-medium">
            هر آنچه که قبل از ثبت‌نام باید بدانید. ما از راه‌اندازی کامل و انطباق حقوقی اکانت شما در بریتانیا و فرانسه پشتیبانی می‌کنیم.
          </p>
        </div>
          ...
          <div className="relative group perspective">
            ...
            <div className="relative bg-zinc-900/60 backdrop-blur-2xl border border-zinc-800 group-hover:border-emerald-500/50 p-8 rounded-3xl transition-all duration-500 transform group-hover:-translate-y-2 group-hover:shadow-[0_20px_40px_rgba(16,185,129,0.15)]">
              ...
              <div className="flex items-center space-x-4 space-x-reverse mb-8 border-b border-zinc-800 pb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white">بریتانیا (United Kingdom)</h3>
                  <p className="text-emerald-400 text-sm font-medium">قوانین کار آزاد (Self-Employed Rider)</p>
                </div>
              </div>
              ...
              <ul className="space-y-6">
                <li className="flex items-start space-x-4 space-x-reverse">
                  ...
                  <div>
                    <h4 className="text-white font-bold">حق کار در بریتانیا (Right to Work)</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">داشتن پاسپورت معتبر بریتانیا/ایرلند، کارت اقامت بیومتریک (BRP)، یا Share Code رسمی که حق کار شما را ثابت کند.</p>
                  </div>
                </li>
                <li className="flex items-start space-x-4 space-x-reverse">
                  <ShieldCheck className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="text-white font-bold">شرایط سنی و بررسی سوءپیشینه</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">متقاضی باید بالای ۱۸ سال باشد. بررسی سوابق کیفری پایه (DBS) از نظر قانونی الزامی است و توسط ما در طول فرآیند انجام می‌شود.</p>
                  </div>
                </li>
                <li className="flex items-start space-x-4 space-x-reverse">
                  <Car className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="text-white font-bold">وسایل نقلیه و بیمه</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">استفاده از دوچرخه، اسکوتر یا ماشین مجاز است. وسایل نقلیه موتوردار به بیمه مخصوص تحویل غذا (Hire and Reward) نیاز دارند.</p>
                  </div>
                </li>
                <li className="flex items-start space-x-4 space-x-reverse">
                  <Building2 className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="text-white font-bold">حساب بانکی بریتانیا</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">داشتن یک حساب بانکی فعال در بریتانیا به نام خودتان برای دریافت درآمدهای هفتگی.</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="relative bg-zinc-900/60 backdrop-blur-2xl border border-zinc-800 group-hover:border-cyan-500/50 p-8 rounded-3xl transition-all duration-500 transform group-hover:-translate-y-2 group-hover:shadow-[0_20px_40px_rgba(6,182,212,0.15)]">
              ...
              <div className="flex items-center space-x-4 space-x-reverse mb-8 border-b border-zinc-800 pb-6">
                ...
                <div>
                  ...
                  <p className="text-cyan-400 text-sm font-medium">مقررات کسب‌وکارهای خرد (Micro-entrepreneur)</p>
                </div>
              </div>
              ...
              <ul className="space-y-6">
                <li className="flex items-start space-x-4 space-x-reverse">
                  ...
                  <div>
                    <h4 className="text-white font-bold">وضعیت شغلی (Micro-entrepreneur)</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">ثبت‌نام به عنوان Auto-entrepreneur الزامی است. شما باید شماره معتبر SIRET و گواهی Extrait Kbis را ارائه دهید.</p>
                  </div>
                </li>
                <li className="flex items-start space-x-4 space-x-reverse">
                  <FileText className="w-6 h-6 text-cyan-400 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="text-white font-bold">اقامت و هویت فرانسوی</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">کارت شناسایی اتحادیه اروپا، پاسپورت، یا مجوز اقامت معتبر (Titre de Séjour) که اجازه کار آزاد در فرانسه را بدهد.</p>
                  </div>
                </li>
                <li className="flex items-start space-x-4 space-x-reverse">
                  <Scale className="w-6 h-6 text-cyan-400 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="text-white font-bold">مقررات وسایل نقلیه</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">استفاده از دوچرخه استاندارد است. استفاده از اسکوتر یا ماشین نیازمند گواهی "Capacité de transport de marchandises" می‌باشد.</p>
                  </div>
                </li>
                <li className="flex items-start space-x-4 space-x-reverse">
                  <Building2 className="w-6 h-6 text-cyan-400 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="text-white font-bold">حساب بانکی SEPA</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">داشتن حساب بانکی معتبر در منطقه SEPA به نام خودتان برای پردازش تراکنش‌های مالی اروپا.</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-zinc-800/50">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800 hover:border-emerald-500/50 p-8 rounded-3xl transition-all duration-300 transform hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(16,185,129,0.1)] group">
            ...
            <h3 className="text-xl font-bold text-white mb-3">روند ۱۰۰٪ امن</h3>
            <p className="text-zinc-400 text-sm leading-relaxed">
              تمامی مدارک شما با استانداردهای سخت‌گیرانه رمزنگاری محافظت می‌شوند. ما امنیت کامل فرآیند ثبت‌نام را تضمین می‌کنیم.
            </p>
          </div>
          ...
          <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800 hover:border-cyan-500/50 p-8 rounded-3xl transition-all duration-300 transform hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(6,182,212,0.1)] group">
            ...
            <h3 className="text-xl font-bold text-white mb-3">سریع و کارآمد</h3>
            <p className="text-zinc-400 text-sm leading-relaxed">
              بدون سردرگمی و اتلاف وقت. فرم‌های بهینه‌سازی شده و تیم متخصص ما اطمینان می‌دهند که اکانت شما در کوتاه‌ترین زمان ممکن تأیید شود.
            </p>
          </div>
          ...
          <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800 hover:border-emerald-500/50 p-8 rounded-3xl transition-all duration-300 transform hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(16,185,129,0.1)] group">
            ...
            <h3 className="text-xl font-bold text-white mb-3">پشتیبانی زنده واتساپ</h3>
            <p className="text-zinc-400 text-sm leading-relaxed">
              ما قدم به قدم شما را راهنمایی می‌کنیم. از زمان ارسال مدارک تا تأیید زنده چهره، تیم ما تنها یک پیام با شما فاصله دارد.
            </p>
          </div>
