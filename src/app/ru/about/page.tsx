...
// Словарь переводов (включая английский и русский языки)
const translations: Record<string, any> = {
  ...
  ru: {
    title: "О компании Safi Agency",
    subtitle: "Официальное подразделение верификации и цифровых услуг компании Safi International Capital LTD.",
    legalTitle: "Юридически зарегистрирована в Великобритании",
    legalDesc: "Safi Agency работает под управлением Safi International Capital LTD, зарегистрированной частной компании с ограниченной ответственностью в Великобритании (Рег. номер: 17063286). Мы строго соблюдаем европейские и британские бизнес-стандарты.",
    privacyTitle: "Строгая конфиденциальность и защита данных",
    privacyDesc: "Ваши документы, удостоверяющие личность, паспорта и подтверждения адреса шифруются и обрабатываются со 100% конфиденциальностью. Мы никогда не передаем ваши данные неавторизованным третьим лицам.",
    whatWeDoTitle: "Что мы делаем",
    whatWeDoDesc: "Мы предоставляем комплексные услуги по настройке аккаунтов «под ключ» для мигрантов и граждан в Великобритании и Европе. От аккаунтов курьеров Deliveroo до настройки международного банкинга — мы берем на себя все юридические требования.",
    ecoTitle: "Цифровая экосистема Safi",
    ecoDesc: "Исследуйте нашу глобальную сеть финансовых, образовательных и цифровых платформ.",
    teamTitle: "Наша команда руководителей",
    dir: "ltr",
    companyNum: "Регистрационный номер компании в УК: 17063286",
    networkBadge: "Глобальная сеть",
    teamSubtitle: "Под руководством отраслевых экспертов в области финтеха, разработки и международных отношений."
  }
};

// Список экосистемы с поддержкой русского языка
const getEcosystem = (lang: string) => [
  {
    ...
    desc: lang === 'ru' ? "Материнская компания и подразделение международных инвестиций (Рег. UK: 17063286)." : "Parent company & international investment arm (UK Reg: 17063286)."
  },
  {
    name: "SafiPay",
    url: "https://safipay.net/",
    logo: "https://img.logo.dev/safipay.net?token=pk_KFxIPBNeQa6ZPc2CP18vhQ&format=webp&retina=true",
    desc: lang === 'ru' ? "Мультивалютный международный банкинг и выпуск виртуальных карт." : "Multi-currency international banking & virtual card issuance."
  },
  {
    name: "Safi TopUp",
    url: "https://safitopup.site",
    logo: "/company/safi-topup.jpg",
    desc: lang === 'ru' ? "Глобальное пополнение мобильной связи, интернет-пакеты и подарочные карты." : "Global mobile recharges, data bundles, and gift cards."
  },
  {
    name: "SafiPro",
    url: "https://safipro.site",
    logo: "/company/SafiPro.jpg",
    desc: lang === 'ru' ? "Премиальный бренд электронной коммерции для современной и индивидуальной одежды." : "Premium e-commerce brand for modern and custom apparel."
  },
  {
    name: "Safi Academy",
    url: "https://safiacademy.org/",
    logo: "/company/academy.jpg",
    desc: lang === 'ru' ? "Глобальная платформа сертификации в сфере IT и цифровых финансов." : "Global IT & digital financial certification platform."
  },
  {
    name: "Safi AI",
    url: "https://www.safiai.site/",
    logo: "/company/ailogo.png",
    desc: lang === 'ru' ? "Продвинутая генерация текста, изображений и видео с помощью мультимодального ИИ." : "Advanced multi-modal AI text, image, and video generation."
  },
  {
    ...
    desc: lang === 'ru' ? "Аналитика и новости от нашего основателя и генерального директора." : "Insights and updates from our Founder & CEO."
  }
];

// Список команды руководства с ролями на русском языке
const getTeam = (lang: string) => [
  { 
    name: "Shaheen Safi", 
    role: lang === 'ru' ? "Основатель, генеральный директор и главный архитектор" : "Founder, CEO & Chief Architect", 
    image: "/team/shaheen.jpeg" 
  },
  { 
    name: "Mujtaba Rahmani", 
    role: lang === 'ru' ? "Операционный директор (COO)" : "Chief Operating Officer (COO)", 
    image: "/team/mujtaba.jpeg" 
  },
  { 
    name: "Sahel Salem", 
    role: lang === 'ru' ? "Директор по европейским связям" : "European Relations Director", 
    image: "/team/sahel.jpeg" 
  },
  { 
    name: "Shirin Gol Ahmadi", 
    role: lang === 'ru' ? "Менеджер компании и руководитель направления ИИ" : "Company Manager & AI Lead", 
...
export default function AboutPage() {
  ...
  const currentLangCode = pathname.split('/')[1] === 'ru' ? 'ru' : 'en';
