...
export default function TurkishHomePage() {
  return (
    // Türkçe için ltr yönü ve sol hizalama sınıfı
    <div dir="ltr" className="min-h-screen bg-black text-white relative overflow-hidden">
      
      {/* --- Arka plan 3D ışık efektleri ve animasyonlar --- */}
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24 lg:pt-24">
        <div className="text-center max-w-4xl mx-auto space-y-8 relative">
          ...
          <div className="inline-flex items-center space-x-2 bg-emerald-500/10 border border-emerald-500/30 px-5 py-2 rounded-full text-emerald-400 text-sm font-semibold shadow-[0_0_30px_rgba(16,185,129,0.2)] transform hover:scale-105 transition-transform duration-300">
            ...
            <span>UK ve Avrupa'da Resmi Belge Kayıt ve Doğrulama Ortağı</span>
          </div>

          <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight leading-tight">
            Dijital yolculuğunuzu <br className="hidden sm:block" />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-cyan-400 to-emerald-500 drop-shadow-lg">
              kolay ve güvenli hale getirin
            </span>
          </h1>

          <p className="text-lg text-zinc-400 leading-relaxed max-w-2xl mx-auto font-medium">
            Safi Agency %100 güvenli ve profesyonel hesap kurulum hizmetleri sunar. Deliveroo kurye hesabı açılışından tam yasal belge doğrulamasına kadar; gelir elde etmeye endişesiz başlamanız için tüm zor işleri biz hallediyoruz.
          </p>

          {/* Eylem Çağrısı (Call to Action) düğmeleri */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-6">
            ...
            >
              <span>Deliveroo Hesabı Kaydı</span>
      ...
      {/* ================= DELIVEROO REQUIREMENTS SECTION (Deliveroo Kuralları Bölümü) ================= */}
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-zinc-800/50">
        ...
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-3xl md:text-5xl font-extrabold text-white">
            Resmi Deliveroo Kuralları ve Gereksinimleri
          </h2>
          <p className="text-zinc-400 max-w-2xl mx-auto font-medium">
            Kayıt olmadan önce bilmeniz gereken her şey. İngiltere ve Fransa'daki hesap kurulumunuzu ve yasal uyumluluğunuzu tam olarak destekliyoruz.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          
          {/* Birleşik Krallık Kuralları Kartı (UK) */}
          <div className="relative group perspective">
            ...
            <div className="relative bg-zinc-900/60 backdrop-blur-2xl border border-zinc-800 group-hover:border-emerald-500/50 p-8 rounded-3xl transition-all duration-500 transform group-hover:-translate-y-2 group-hover:shadow-[0_20px_40px_rgba(16,185,129,0.15)]">
              ...
              <div className="flex items-center space-x-4 mb-8 border-b border-zinc-800 pb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white">Birleşik Krallık</h3>
                  <p className="text-emerald-400 text-sm font-medium">Serbest Çalışan Kurye Kuralları (Self-Employed Rider)</p>
                </div>
              </div>
              ...
              <ul className="space-y-6">
                <li className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-white font-bold">İngiltere'de Çalışma Hakkı (Right to Work)</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">Geçerli İngiliz/İrlanda pasaportu, Biyometrik Oturma İzni (BRP) veya çalışma hakkınızı kanıtlayan resmi Share Code.</p>
                  </div>
                </li>
                <li className="flex items-start space-x-4">
                  <ShieldCheck className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="text-white font-bold">Yaş ve Sabıka Kaydı Kontrolü</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">Başvuru sahibi 18 yaş ve üzerinde olmalıdır. Temel sabıka kaydı kontrolü (DBS) yasal olarak zorunludur ve süreç boyunca bizim tarafımızdan gerçekleştirilir.</p>
                  </div>
                </li>
                <li className="flex items-start space-x-4">
                  <Car className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="text-white font-bold">Araçlar ve Sigorta</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">Bisiklet, scooter veya araba kullanımı yasaldır. Motorlu taşıtlar özel yemek teslimat sigortasına (Hire and Reward) ihtiyaç duyar.</p>
                  </div>
                </li>
                <li className="flex items-start space-x-4">
                  <Building2 className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="text-white font-bold">İngiltere Banka Hesabı</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">Haftalık kazançlarınızı almak için kendi adınıza aktif bir İngiltere banka hesabına sahip olmak.</p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="relative group perspective">
            ...
            <div className="relative bg-zinc-900/60 backdrop-blur-2xl border border-zinc-800 group-hover:border-cyan-500/50 p-8 rounded-3xl transition-all duration-500 transform group-hover:-translate-y-2 group-hover:shadow-[0_20px_40px_rgba(6,182,212,0.15)]">
              ...
              <div className="flex items-center space-x-4 mb-8 border-b border-zinc-800 pb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white">Fransa</h3>
                  <p className="text-cyan-400 text-sm font-medium">Küçük İşletme Düzenlemeleri (Micro-entrepreneur)</p>
                </div>
              </div>
              ...
              <ul className="space-y-6">
                <li className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-white font-bold">Çalışma Statüsü (Micro-entrepreneur)</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">Auto-entrepreneur olarak kayıt zorunludur. Geçerli bir SIRET numarası ve Extrait Kbis belgesi sunmalısınız.</p>
                  </div>
                </li>
                <li className="flex items-start space-x-4">
                  <FileText className="w-6 h-6 text-cyan-400 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="text-white font-bold">Fransız İkameti ve Kimliği</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">AB kimlik kartı, pasaport veya Fransa'da serbest çalışma hakkı veren geçerli oturum izni (Titre de Séjour).</p>
                  </div>
                </li>
                <li className="flex items-start space-x-4">
                  <Scale className="w-6 h-6 text-cyan-400 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="text-white font-bold">Araç Düzenlemeleri</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">Bisiklet standarttır. Scooter veya araba kullanımı "Capacité de transport de marchandises" belgesi gerektirir.</p>
                  </div>
                </li>
                <li className="flex items-start space-x-4">
                  <Building2 className="w-6 h-6 text-cyan-400 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="text-white font-bold">SEPA Banka Hesabı</h4>
                    <p className="text-zinc-400 text-sm mt-1 leading-relaxed">Avrupa finansal işlemlerini ve ödemelerini yürütmek için SEPA bölgesinde kendi adınıza geçerli bir banka hesabı.</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-zinc-800/50">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800 hover:border-emerald-500/50 p-8 rounded-3xl transition-all duration-300 transform hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(16,185,129,0.1)] group">
            ...
            <h3 className="text-xl font-bold text-white mb-3">%100 Güvenli Süreç</h3>
            <p className="text-zinc-400 text-sm leading-relaxed">
              Tüm belgeleriniz sıkı şifreleme standartlarıyla korunur. Kayıt sürecinin tam güvenliğini garanti ediyoruz.
            </p>
          </div>
          ...
          <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800 hover:border-cyan-500/50 p-8 rounded-3xl transition-all duration-300 transform hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(6,182,212,0.1)] group">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Hızlı ve Verimli</h3>
            <p className="text-zinc-400 text-sm leading-relaxed">
              Karmaşa ve zaman kaybı yok. Optimize edilmiş formlarımız ve uzman ekibimiz hesabınızın en kısa sürede onaylanmasını sağlar.
            </p>
          </div>
          ...
          <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800 hover:border-emerald-500/50 p-8 rounded-3xl transition-all duration-300 transform hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(16,185,129,0.1)] group">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Canlı WhatsApp Desteği</h3>
            <p className="text-zinc-400 text-sm leading-relaxed">
              Adım adım yanınızdayız. Belge gönderiminden canlı yüz doğrulamasına kadar ekibimiz sadece bir mesaj uzağınızda.
            </p>
          </div>
