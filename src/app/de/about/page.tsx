...
// دیکشنری هوشمند ترجمه‌ها (شامل انگلیسی، فارسی، پشتو و آلمانی)
const translations: Record<string, any> = {
  ...
  de: {
    title: "Über Safi Agency",
    subtitle: "Der offizielle Verifizierungs- und Digitaldienstleistungsarm der Safi International Capital LTD.",
    legalTitle: "Rechtlich in UK registriert",
    legalDesc: "Safi Agency operiert unter der Safi International Capital LTD, einer eingetragenen Gesellschaft mit beschränkter Haftung im Vereinigten Königreich (Reg.-Nr.: 17063286). Wir halten uns strikt an europäische und britische Geschäftsstandards.",
    privacyTitle: "Strenger Datenschutz & Privatsphäre",
    privacyDesc: "Ihre Ausweisdokumente, Reisepässe und Adressnachweise werden verschlüsselt und mit 100% Vertraulichkeit behandelt. Wir geben Ihre Daten niemals an unbefugte Dritte weiter.",
    whatWeDoTitle: "Was wir tun",
    whatWeDoDesc: "Wir bieten umfassende Dienstleistungen zur Kontoeinrichtung für Migranten und Bürger in Großbritannien und Europa. Von Deliveroo-Rider-Konten bis hin zu internationalen Bankeinrichtungen – wir navigieren durch die rechtlichen Anforderungen für Sie.",
    ecoTitle: "Safi Digitales Ökosystem",
    ecoDesc: "Entdecken Sie unser globales Netzwerk aus Finanz-, Bildungs- und Digitalplattformen.",
    teamTitle: "Unser Führungsteam",
    dir: "ltr",
    companyNum: "UK-Handelsregisternummer: 17063286",
    networkBadge: "Globales Netzwerk",
    teamSubtitle: "Geleitet von Branchenexperten in den Bereichen Fintech, Entwicklung und internationale Beziehungen."
  }
};

// لیست اکوسیستم شرکت‌های شما با پشتیبانی از زبان آلمانی
const getEcosystem = (lang: string) => [
  {
    ...
    desc: lang === 'de' ? "Muttergesellschaft & internationaler Investitionsarm (UK Reg: 17063286)." : "Parent company & international investment arm (UK Reg: 17063286)."
  },
  {
    name: "SafiPay",
    url: "https://safipay.net/",
    logo: "https://img.logo.dev/safipay.net?token=pk_KFxIPBNeQa6ZPc2CP18vhQ&format=webp&retina=true",
    desc: lang === 'de' ? "Währungsübergreifendes internationales Banking & virtuelle Karten." : "Multi-currency international banking & virtual card issuance."
  },
  {
    name: "Safi TopUp",
    url: "https://safitopup.site",
    logo: "/company/safi-topup.jpg",
    desc: lang === 'de' ? "Globale Mobilfuntaufladungen, Datenpakete und Geschenkkarten." : "Global mobile recharges, data bundles, and gift cards."
  },
  {
    name: "SafiPro",
    url: "https://safipro.site",
    logo: "/company/SafiPro.jpg",
    desc: lang === 'de' ? "Premium-E-Commerce-Marke für moderne und maßgeschneiderte Bekleidung." : "Premium e-commerce brand for modern and custom apparel."
  },
  {
    name: "Safi Academy",
    url: "https://safiacademy.org/",
    logo: "/company/academy.jpg",
    desc: lang === 'de' ? "Globale Plattform für IT- und digitale Finanzzertifizierungen." : "Global IT & digital financial certification platform."
  },
  {
    name: "Safi AI",
    url: "https://www.safiai.site/",
    logo: "/company/ailogo.png",
    desc: lang === 'de' ? "Erweiterte multimodale KI-Text-, Bild- und Videogenerierung." : "Advanced multi-modal AI text, image, and video generation."
  },
  {
    ...
    desc: lang === 'de' ? "Einblicke und Updates von unserem Gründer & CEO." : "Insights and updates from our Founder & CEO."
  }
];

// لیست تیم مدیریتی به همراه ترجمه نقش‌ها به آلمانی
const getTeam = (lang: string) => [
  { 
    name: "Shaheen Safi", 
    role: lang === 'de' ? "Gründer, CEO & Chefarchitekt" : "Founder, CEO & Chief Architect", 
    image: "/team/shaheen.jpeg" 
  },
  { 
    name: "Mujtaba Rahmani", 
    role: lang === 'de' ? "Chief Operating Officer (COO)" : "Chief Operating Officer (COO)", 
    image: "/team/mujtaba.jpeg" 
  },
  { 
    name: "Sahel Salem", 
    role: lang === 'de' ? "Leiter für europäische Beziehungen" : "European Relations Director", 
    image: "/team/sahel.jpeg" 
  },
  { 
    name: "Shirin Gol Ahmadi", 
    role: lang === 'de' ? "Unternehmensleiterin & KI-Leitung" : "Company Manager & AI Lead", 
...
export default function AboutPage() {
  ...
  const currentLangCode = pathname.split('/')[1] === 'de' ? 'de' : 'en';
