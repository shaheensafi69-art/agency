...
// دیکشنری هوشمند ترجمه‌ها (شامل انگلیسی، فارسی، پشتو، آلمانی، اردو و فرانسوی)
const translations: Record<string, any> = {
  ...
  fr: {
    title: "À propos de Safi Agency",
    subtitle: "La branche officielle de vérification et de services numériques de Safi International Capital LTD.",
    legalTitle: "Légalement enregistré au Royaume-Uni",
    legalDesc: "Safi Agency opère sous l'égide de Safi International Capital LTD, une société privée à responsabilité limitée enregistrée au Royaume-Uni (N° de société : 17063286). Nous respectons des normes commerciales européennes et britanniques strictes.",
    privacyTitle: "Confidentialité stricte et protection des données",
    privacyDesc: "Vos documents d'identité, passeports et justificatifs de domicile sont cryptés et traités avec une confidentialité à 100 %. Nous ne partagemos jamais vos données avec des tiers non autorisés.",
    whatWeDoTitle: "Ce que nous faisons",
    whatWeDoDesc: "Nous fournissons des services de configuration de compte de zéro à cent pour les migrants et les citoyens au Royaume-Uni et en Europe. Des comptes de livreur Deliveroo aux configurations bancaires internationales, nous gérons les exigences légales pour vous.",
    ecoTitle: "Écosystème Numérique Safi",
    ecoDesc: "Explorez notre réseau mondial de plateformes financières, éducatives et numériques.",
    teamTitle: "Notre Équipe de Direction",
    dir: "ltr",
    companyNum: "Numéro d'entreprise UK : 17063286",
    networkBadge: "Réseau Mondial",
    teamSubtitle: "Dirigé par des experts de l'industrie en fintech, développement et relations internationales."
  }
};

// لیست اکوسیستم شرکت‌ها با پشتیبانی از زبان فرانسوی
const getEcosystem = (lang: string) => [
  {
    ...
    desc: lang === 'fr' ? "Société mère et bras d'investissement international (Rég. UK : 17063286)." : "Parent company & international investment arm (UK Reg: 17063286)."
  },
  {
    name: "SafiPay",
    url: "https://safipay.net/",
    logo: "https://img.logo.dev/safipay.net?token=pk_KFxIPBNeQa6ZPc2CP18vhQ&format=webp&retina=true",
    desc: lang === 'fr' ? "Services bancaires internationaux multi-devises et émission de cartes virtuelles." : "Multi-currency international banking & virtual card issuance."
  },
  {
    name: "Safi TopUp",
    url: "https://safitopup.site",
    logo: "/company/safi-topup.jpg",
    desc: lang === 'fr' ? "Recharges mobiles mondiales, forfaits de données et cartes cadeaux." : "Global mobile recharges, data bundles, and gift cards."
  },
  {
    name: "SafiPro",
    url: "https://safipro.site",
    logo: "/company/SafiPro.jpg",
    desc: lang === 'fr' ? "Marque e-commerce premium pour des vêtements modernes et personnalisés." : "Premium e-commerce brand for modern and custom apparel."
  },
  {
    name: "Safi Academy",
    url: "https://safiacademy.org/",
    logo: "/company/academy.jpg",
    desc: lang === 'fr' ? "Plateforme mondiale de certification informatique et financière numérique." : "Global IT & digital financial certification platform."
  },
  {
    name: "Safi AI",
    url: "https://www.safiai.site/",
    logo: "/company/ailogo.png",
    desc: lang === 'fr' ? "Génération avancée de texte, d'images et de vidéos par IA multimodale." : "Advanced multi-modal AI text, image, and video generation."
  },
  {
    ...
    desc: lang === 'fr' ? "Perspectives et actualités de notre fondateur et PDG." : "Insights and updates from our Founder & CEO."
  }
];

// لیست تیم مدیریتی به همراه نقش‌ها به زبان فرانسوی
const getTeam = (lang: string) => [
  { 
    name: "Shaheen Safi", 
    role: lang === 'fr' ? "Fondateur, PDG & Architecte en chef" : "Founder, CEO & Chief Architect", 
    image: "/team/shaheen.jpeg" 
  },
  { 
    name: "Mujtaba Rahmani", 
    role: lang === 'fr' ? "Directeur des Opérations (COO)" : "Chief Operating Officer (COO)", 
    image: "/team/mujtaba.jpeg" 
  },
  { 
    name: "Sahel Salem", 
    role: lang === 'fr' ? "Directeur des Relations Européennes" : "European Relations Director", 
    image: "/team/sahel.jpeg" 
  },
  { 
    name: "Shirin Gol Ahmadi", 
    role: lang === 'fr' ? "Responsable de l'entreprise & Lead IA" : "Company Manager & AI Lead", 
...
export default function AboutPage() {
  ...
  const currentLangCode = pathname.split('/')[1] === 'fr' ? 'fr' : 'en';
